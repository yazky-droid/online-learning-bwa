...
class CourseController extends Controller
{
    ...
    {
        // get all data courses and show it
        // accessible by teacher and owner
        // just showing the data that created and owned by the teacher
    ...
    public function destroy(Course $course)
    {
        ...
        try {
            ...
            return redirect()->route('admin.courses.index')->with('error', 'Terjadinya sebuah error ketika menghapus data courses');
        }
    }
}
